...
**Response**: Setting message to false does not return the message you get in the console from loading the tidyverse in the Rmd file and setting it to true does print in the Rmd file what is returned in the R console when loading tidyverse.
...
**Response**: Same thing as before, setting message to false does not return the message you get in the console from loading the data in the Rmd file and setting it to true does print in the Rmd file what is returned in the R console when loading the data.
...
Temps output was the entire dataset and college_recent_grads only returned the first 10 rows.
...
**Response**: We definitely need major and unemployment rate. I would probably use excel, have the data formatted as a table and sort the row with unemployment rate ascending.
...
**Response**: There are 5 majors all with 0 for unemployment rate. Mathematics And Computer Science, Military Technologies, Botany, Soil Science, and Educational Administration And Supervision.
...
**Response**: Early Childhood Education has the highest proportion of women with 96.9%.
...
**Response**: These are all of the 10 majors that are STEM majors and have a median salary less than the median salary of all majors.
